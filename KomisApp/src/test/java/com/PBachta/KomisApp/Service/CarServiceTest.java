...
//        assertEquals("putNewCarDataTest function failure - expected first registration date","1998-01-05", carService.getById(1L).getFirstRegistrationDate());
//        assertEquals("putNewCarDataTest function failure - expected registration card issue date", "1998-02-05", carService.getById(1L).getRegistrationCardIssueDate());
